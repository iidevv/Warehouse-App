...
import HhProductPage from "./HhProductPage";
...
} from "../../redux/reducers/hh-product-reducer";
...
let mapStateToProps = (state) => {
  return {
    productData: state.hhProduct.productData,
    content: state.hhProduct.content,
    info: state.hhProduct.info,
    isFetching: state.hhProduct.isFetching,
    categories: state.hhProduct.categories,
    current_categories: state.hhProduct.current_categories,
    create_type: state.hhProduct.create_type,
    create_value: state.hhProduct.create_value,
  };
};
